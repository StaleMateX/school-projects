    ...
    public class CommonController : Controller
    {
        ...
        public IActionResult GetClassOfferings(string subject, int number)
        {
            var query = from c in db.Classes
                        where c.Course.Depart.Subject == subject && c.Course.Number == number
                        select new
                        {
                            season = c.Season,
                            year = c.Year,
        ...
        {
            // find the match student with uid
            ...
            // find the match professor with uid
